      ...
      addJs('https://open.ys7.com/assets/ezuikit_v2.6.4/webrtc/janus.js', function () {
        addJs('https://open.ys7.com/assets/layer/layer.js', function () {
          var EZUIKitWebrtcRoom = function EZUIKitWebrtcRoom(params) {
            ...
            if (params.password) {
              window['ezuikit-webrtc-' + params.id].opt.roomParams.password = params.password;
            }
            if (params.stream) {
            ...
            var JanusParams = {
                ...
                // password: window['ezuikit-webrtc-' + params.id].opt.roomParams.password,
                // authtype: 22
            }
            if (params.type === 'create') {
              ...
              //window['ezuikit-webrtc-' + params.id].opt.stsUrl = "?token=" + window['ezuikit-webrtc-' + params.id].opt.stream;
              window['ezuikit-webrtc-' + params.id].opt.stsUrl += "?userId=" + window['ezuikit-webrtc-' + params.id].opt.roomParams.userId;
              if(window['ezuikit-webrtc-' + params.id].opt.roomParams.dev){ // 有设备
                window['ezuikit-webrtc-' + params.id].opt.stsUrl += "&callType=3&othertype=111&clienttype=105&devstreamtype=2&streamtype=2&video=1&authtype=21&password=" + window['ezuikit-webrtc-' + params.id].opt.roomParams.password;
                window['ezuikit-webrtc-' + params.id].opt.stsUrl += "&dev=" + window['ezuikit-webrtc-' + params.id].opt.roomParams.dev;
                window['ezuikit-webrtc-' + params.id].opt.stsUrl += "&channel=" + window['ezuikit-webrtc-' + params.id].opt.roomParams.channel;
                JanusParams = {
                  device: window['ezuikit-webrtc-' + params.id].opt.roomParams.dev,
              ...
              roomApiUrl = window['ezuikit-webrtc-' + params.id].opt.apiDomain + "/api/v3/conference/gen";
              rommApiParams = {
              ...
              window['ezuikit-webrtc-' + params.id].opt.stsUrl = "?token=" + window['ezuikit-webrtc-' + params.id].opt.stream;
              window['ezuikit-webrtc-' + params.id].opt.stsUrl += "&userId=" + window['ezuikit-webrtc-' + params.id].opt.roomParams.userId;
              window['ezuikit-webrtc-' + params.id].opt.stsUrl += "&callType=1&othertype=115&clienttype=105&devstreamtype=1&streamtype=2&video=1&authtype=21";
              roomApiUrl = window['ezuikit-webrtc-' + params.id].opt.apiDomain + "/api/v3/conference/vtm/" + window['ezuikit-webrtc-' + params.id].opt.roomParams.room;
              roomApiUrl += "?roomId="+ window['ezuikit-webrtc-' + params.id].opt.roomParams.room+"&accessToken="+ window['ezuikit-webrtc-' + params.id].opt.accessToken,
              rommApiParams = {
              };
              roomApiMethod = "GET";
              JanusParams = {
            ...
            function apiSuccess(data) {
              if (data.retcode == 0) {
                var apiResult = data.tokens;
                if (apiResult) {
                  // 加载依赖
                  var stream = apiResult[0];
                  window['ezuikit-webrtc-' + params.id].opt.stream = stream;
                  JanusParams['token'] = stream;
                  var roomApiSuccess = function (roomApiData) {
                    if(roomApiData.meta.code == 200 && roomApiData.conferenceInfos){
                      window['ezuikit-webrtc-' + params.id].opt.roomParams.room = roomApiData.conferenceInfos.roomId;
                      window['ezuikit-webrtc-' + params.id].opt.stsUrl += ('&room=' + roomApiData.conferenceInfos.roomId);
                      window['ezuikit-webrtc-' + params.id].opt.stsUrl += ('&token=' +window['ezuikit-webrtc-' + params.id].opt.stream);
                      window['ezuikit-webrtc-' + params.id].opt.stsUrl = "sts://" + roomApiData.conferenceInfos.vtmAddress + '/rtc' + window['ezuikit-webrtc-' + params.id].opt.stsUrl;
                      JanusParams['room'] =  roomApiData.conferenceInfos.roomId;
                    }
                    console.log("roomApiData", roomApiData);
                                      ...
                                      onmessage: function (msg, jsep) {
                                        ...
                                        if (msg['type'] == 1 && (msg["code"] == 501 || msg["code"] == 502)) {
                                          ...
                                          if (typeof params.onError === 'function') {
                                            ...
                                            params.onError(PrefixCode(msg["code"], '设备正忙，无法加入房间'))
                                          }
                                        }
                                        // 房间已满
                ...
                var roomApiError = function () {
                  params.onError(PrefixCode(data.meta.code, data.meta.msg))
                }
                request(
                  roomApiUrl,
                  roomApiMethod,
            ...
            request(
              window['ezuikit-webrtc-' + params.id].opt.apiDomain.replace('open.ys7.com','openauth.ys7.com') + "/token/gen/user?ssid=" + window['ezuikit-webrtc-' + params.id].opt.accessToken +'&num=10&isReal=true' ,
              'GET',              //window['ezuikit-webrtc-' + params.id].opt.apiDomain + "/api/lapp/live/talk/url",
              {
                accessToken: window['ezuikit-webrtc-' + params.id].opt.accessToken,
                type: 'real',
                num:1
